...
Please install and activate it before starting to use the theme Crafti.
...
Theme documentation is available on https://crafti.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Crafti is Fontello.
