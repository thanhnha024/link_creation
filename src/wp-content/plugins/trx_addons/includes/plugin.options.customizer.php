			...
			if ( ! empty( $result['error'] ) || ! empty( $result['success'] ) ) {
				...
				<div class="trx_addons_options_result">
					...
					if ( ! empty( $result['error'] ) ) {
						?><div id="trx_addons_options_message" class="error"><p><?php echo wp_kses_data($result['error'] ); ?></p></div><?php
					} else if ( ! empty( $result['success'] ) ) {
						?><div id="trx_addons_options_message" class="updated"><p><?php echo wp_kses_data($result['success'] ); ?></p></div><?php
					}
					?>
				</div>
			<?php
