		...
		function add_options( $options ) {
			...
			trx_addons_array_insert_before( $options, 'users_section', apply_filters( 'trx_addons_filter_options_ai_helper', array(
				...
				'ai_helper_model_openai' => array(
					...
					"std" => "gpt-3.5-turbo",
					"options" => apply_filters( 'trx_addons_filter_ai_helper_list_models', Lists::get_list_openai_chat_models(), 'openai' ),
					"type" => "select",
					"dependency" => array(
				...
				'ai_helper_embed_chats' => array(
					...
					"desc" => wp_kses_data( __("Specify a scope and a html code for the each new embeddig. In the 'URL contain' field, you can list the parts of the address (each part separated by a comma or on a new line), if any of which matches the current page, this block will be displayed.", 'trx_addons') ),
					"clone" => true,
					"std" => array(),
					"type" => "group",
					"fields" => array(
				...
				'ai_helper_sc_igenerator_api_order' => array(
					...
					'options' => Lists::get_list_ai_image_apis(),
					"type" => "checklist"
				),
				...
				'ai_helper_sc_chat_api_order' => array(
					...
					"dir" => 'vertical',
					"sortable" => true,
					"std" => array( 'openai' => 1, 'flowise-ai' => 1 ),
					'options' => Lists::get_list_ai_chat_apis(),
					"type" => "checklist"
				),
