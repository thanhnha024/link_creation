...
*/
		 ...
		 * 				  1) if in the 'plain_params' specified 'height' => 'size+unit' and 'height' is an array( 'size' => 100, 'unit' => 'px' )
		 *                   then 'height' will be converted to '100px' and a new attribute 'height_extra' will be added with the original array
		 *                2) if in the 'plain_params' specified 'icon' => 'value.url' and 'icon' is an array( 'value' => array( 'id' => 'test', 'url' => 'https://xxx.yyy' ) )
