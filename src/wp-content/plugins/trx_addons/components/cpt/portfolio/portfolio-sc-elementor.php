...
if (!function_exists('trx_addons_sc_portfolio_add_in_elementor')) {
	add_action( trx_addons_elementor_get_action_for_widgets_registration(), 'trx_addons_sc_portfolio_add_in_elementor' );
	function trx_addons_sc_portfolio_add_in_elementor() {
		...
		class TRX_Addons_Elementor_Widget_Portfolio extends TRX_Addons_Elementor_Widget {
			...
			protected function register_controls() {
				...
				$this->add_control(
					'use_gallery',
					[
						'label' => __( 'Use gallery', 'trx_addons' ),
						'label_block' => false,
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_off' => __( 'Off', 'trx_addons' ),
						'label_on' => __( 'On', 'trx_addons' ),
				...
				$this->add_control(
					...
					[
						...
						'render_type' => 'none',
						'default' => TRX_ADDONS_CPT_PORTFOLIO_PT
					]
				);
				$this->add_control(
					'taxonomy',
					[
						'type' => \Elementor\Controls_Manager::HIDDEN,
						'render_type' => 'none',
						'default' => TRX_ADDONS_CPT_PORTFOLIO_TAXONOMY
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'label_block' => false,
						'type' => \Elementor\Controls_Manager::SELECT,
						'options' => ! $is_edit_mode ? array() : trx_addons_array_merge( array( 0 => trx_addons_get_not_selected_text( esc_html__( 'Select category', 'trx_addons' ) ) ), trx_addons_get_list_terms( false, TRX_ADDONS_CPT_PORTFOLIO_TAXONOMY ) ),
						'default' => '0'
					]
				);
				
				$this->add_query_param('', array(), TRX_ADDONS_CPT_PORTFOLIO_PT);
		...
		// Register widget
		trx_addons_elm_register_widget( 'TRX_Addons_Elementor_Widget_Portfolio' );
	}
}
