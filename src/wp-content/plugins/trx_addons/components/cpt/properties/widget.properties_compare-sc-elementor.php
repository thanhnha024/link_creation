<?php
/**
 * Widget: Properties Compare (Elementor support)
 *
...
if (!function_exists('trx_addons_sc_widget_properties_compare_add_in_elementor')) {
	add_action( trx_addons_elementor_get_action_for_widgets_registration(), 'trx_addons_sc_widget_properties_compare_add_in_elementor' );
	function trx_addons_sc_widget_properties_compare_add_in_elementor() {
		...
		class TRX_Addons_Elementor_Widget_Properties_Compare extends TRX_Addons_Elementor_Widget {
			...
			public function get_keywords() {
				return [ 'property', 'build', 'estate', 'real', 'compare' ];
			}
		...
		// Register widget
		trx_addons_elm_register_widget( 'TRX_Addons_Elementor_Widget_Properties_Compare' );
	}
}
