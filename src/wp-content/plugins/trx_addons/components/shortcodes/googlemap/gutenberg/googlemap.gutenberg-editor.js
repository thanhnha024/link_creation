(function(blocks, i18n, element) {
	...
	blocks.registerBlockType(
		...
		trx_addons_apply_filters( 'trx_addons_gb_map', {
			...
			description: __( "Google map with custom styles and several markers", "trx_addons" ),
			keywords: [ 'googlemap', 'map', 'address', 'marker', 'point' ],
			icon: 'admin-site',
				...
				return trx_addons_gutenberg_block_params(
					{
						...
						'general_params': el( wp.element.Fragment, {},
							trx_addons_gutenberg_add_params( trx_addons_apply_filters( 'trx_addons_gb_map_add_params', [
								...
								{
									'name': 'html',
									'title': __( 'Custom HTML', "trx_addons" ),
									'descr': __( "Custom HTML-code of the marker", "trx_addons" ),
									'type': 'textarea'
								},
								// Marker image
								{
								...
								// Animation
								{
									...
									'descr': __( "Marker's animation", "trx_addons" ),
									'type': 'select',
